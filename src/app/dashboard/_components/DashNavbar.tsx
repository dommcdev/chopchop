...
export function DashNavbar() {
  return (
    <nav className="border-b-[3px] border-foreground relative z-50 flex items-center justify-between bg-background px-4 py-3 dark:bg-[oklch(0.18_0_0)] sm:px-6 lg:px-8 print:hidden">
